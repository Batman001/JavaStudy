...
//        System.out.println("调用多个参数的父类Hero的构造方法");
    ...
    protected static void battleWin(){
         ...
         */
//        System.out.println(name + "battle win");
...
//        System.out.println(teemo.name);   // 打印结果提莫3
        ...
        /**
         * 都会改变的，因为copyright为类属性，类似于全局变量，
         * 任何地方修改了这个属性，那么其他使用这个属性的地方都会修改。
        ...
        // h指向为对象类型为Support,打印名称为蔡文姬
        System.out.println(h.name);

        // 将h引用所指向的对象Support,转化为ad引用的类型ADHero,
        //ad = (ADHero)h;
...
//        ADAPHero adaphero = (ADAPHero) adi;
        ...
        // 盖伦 Object调用类中toString方法 返回当前对象的字符串的值
